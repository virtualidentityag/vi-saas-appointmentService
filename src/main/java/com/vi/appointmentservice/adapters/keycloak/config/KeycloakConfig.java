...
public class KeycloakConfig {
  ...
  @Bean
  @Qualifier("keycloakAuthenticationToken")
  ...
  @Bean
  @Scope(scopeName = WebApplicationContext.SCOPE_REQUEST, proxyMode = ScopedProxyMode.TARGET_CLASS)
  public KeycloakSecurityContext keycloakSecurityContext(@Qualifier("keycloakAuthenticationToken") KeycloakAuthenticationToken token) {
