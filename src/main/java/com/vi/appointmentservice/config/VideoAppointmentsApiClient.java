...
/**
 * Extension of the generated AppointmentService API client to adapt the handling of parameter values.
 */
public class VideoAppointmentsApiClient extends com.vi.appointmentservice.appointmentservice.generated.ApiClient {

  private static final String FILTER_NAME = "filter";

  public VideoAppointmentsApiClient(RestTemplate restTemplate) {
    super(restTemplate);
  }
