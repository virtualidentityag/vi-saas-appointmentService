...
/**
 * Extension of the generated AdminUserService API client to adapt the handling of parameter values.
 */
public class AdminUserApiClient extends com.vi.appointmentservice.useradminservice.generated.ApiClient {

  private static final String FILTER_NAME = "filter";

  public AdminUserApiClient(RestTemplate restTemplate) {
    super(restTemplate);
  }
